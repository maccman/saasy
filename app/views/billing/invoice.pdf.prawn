...
# 
# pdf.cell pdf.bounds.top_left,
#   :text => "STATEMENT / TAX INVOICE",
#   :horizontal_padding => 10,
#   :vertical_padding => 5,
#   :width => 150,
#   :font_size => 24
#   
# pdf.cell [pdf.bounds.left, pdf.bounds.top - 60],
#   :text => @recipient,
#   :horizontal_padding => 10,
#   :vertical_padding => 5,
#   :width => 150
# 
# pdf.bounding_box([pdf.bounds.right - 210, pdf.bounds.top]) do
#   pdf.cell pdf.bounds.top_left,
...
#       
# pdf.pad(10) do
#   pdf.text "Work Period Details", :align => :center, :size => 16
# end
# 
# pdf.pad(5) do
#   pdf.table [["Total Due:"]],
...
# end
# 
# pdf.y = pdf.bounds.bottom + 20
# pdf.stroke_horizontal_line pdf.bounds.left, pdf.bounds.right
# pdf.text "Please feel free to email #{@email} with any problems.", :at => [0,0]